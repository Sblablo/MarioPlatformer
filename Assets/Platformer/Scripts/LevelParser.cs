    ...
    void LoadLevel()
    {
        ...
        while (levelRows.Count > 0)
        {
            ...
            for (int col = 0; col < letters.Length; ++col)
            {
                ...
                GameObject nouveau = null;
                if (letters[col] == 'x')
                {
                    nouveau = rockPrefab;
                    //nouveau.transform.position = new Vector3(col, row, 0f);
                    //nouveau.transform.parent = environmentRoot;
                    //Instantiate(nouveau);
                }
                ...
                {
                    //Instantiate(nouveau);
                    //nouveau.transform.SetParent(environmentRoot);
                    //nouveau.transform.position = new Vector3(col, row, 0f);
                    Instantiate(nouveau, new Vector3(col, row, 0f), Quaternion.Euler(0,0,0), environmentRoot);
                }
